...
int main(){
	...
	char func[50],f[50],vda[5],nomArch[31],rta[50000],sectores[50000];
...
// NOTA:  para el handshake es CLAVE agregar el \0 para qe pise el mensaje anterior porque sino queda en buffer
	...
	remote.sin_addr.s_addr=inet_addr("201.250.183.140");
...
char* eliminarArchivo (char *vda, char *nombreArchivo){
	...
	int i=0,j=0;
	char dir[100],info[50000], listaSectores[50000];
